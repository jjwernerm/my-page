    ...
    <>
      <div>
        ...
        <div className="text-gray-300 p-5">
          <blockquote>
            Hola, soy <span className="before:block before:absolute before:-inset-0 before:-skew-y-6 before:bg-cyan-800 relative inline-block">
              <span className="relative text-white font-bold"> Joanny Werner </span>
